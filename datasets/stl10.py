...
# TODO: Add support for the STL10 dataset.
class Dataset(base.ImageDataset):
    ...
    def get_train_set(use_augmentation):
        ...
        train_set = torchvision.datasets.STL10(
            split='train', root=os.path.join(get_platform().dataset_root, 'stl10'),
                                             transform=augmentation, target_transform=augmentation,
            download=True)
